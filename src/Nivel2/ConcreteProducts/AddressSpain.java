...
public class AddressSpain implements Address {
    ...
    public AddressSpain (String streetType, int number, String street, int postCode, String city, String province){
    ...
    public String getAddress(){
        return ("Address: " + streetType + " " + street + " " + number + ", " + postCode + " " + city + " (" + province + "), " +  SPAIN);
    }
}